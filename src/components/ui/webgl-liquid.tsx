...
import { WebGLErrorBoundary, WebGLFallback } from "@/components/ui/webgl-liquid-utils/webgl-error-boundary";
  ...
  return (
    <WebGLErrorBoundary fallback={fallbackContent}>
      <div
        ref={hostRef}
        className={cn(
          "relative flex min-h-screen w-full items-center overflow-hidden bg-transparent text-white",
          className,
        )}
        style={{ containerType: "size", ...style }}
        {...props}
